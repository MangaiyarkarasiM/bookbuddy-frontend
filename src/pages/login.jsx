...
function LoginPage() {
  const { onLogin, message, setMessage, spin, setSpin } = useContext(GlobalContext);
  ...
  return (
    <div className="my-24 flex flex-col">
      <h3 className="text-emerald-500 text-center text-2xl font-medium mb-5">
        Book Buddy
      </h3>
      <div className="mt-5 flex flex-col bg-white border rounded-md shadow w-3/4 md:w-1/2 mx-auto">
          ...
          {() => {
            return (
              <Form className="flex flex-col items-center justify-center px-2">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center text-white border rounded-md bg-blue-900 mb-5 px-10 py-2 hover:bg-blue-800"
                >
                  {spin ? (
                    <>
                      <svg
        ...
        <div className="text-center text-xs mb-5">
          <p>
            New user?{" "}
            <Link className="italic text-emerald-500" to="/signup">
              Sign up
            </Link>{" "}
            here
          </p>
